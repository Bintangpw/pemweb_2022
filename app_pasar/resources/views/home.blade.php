                    ...
                    <div class="card border-0 shadow">
                        <div class="card-body">
                            <div class="row" bis_skin_checked="1">
                                <div class="col-12 col-sm-6 col-xl-4 mb-4" bis_skin_checked="1">
                                    <div class="card border-0 shadow" bis_skin_checked="1">
                                        <div class="card-body" bis_skin_checked="1">
                                            <div class="row d-block d-xl-flex align-items-center" bis_skin_checked="1">
                                                <div class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center" bis_skin_checked="1">
                                                    <div class="icon-shape icon-shape-primary rounded me-4 me-sm-0" bis_skin_checked="1">
                                                    ...
                                                    <div class="d-sm-none" bis_skin_checked="1">
                                ...
                                <div class="col-12 col-sm-6 col-xl-4 mb-4" bis_skin_checked="1">
                                    <div class="card border-0 shadow" bis_skin_checked="1">
                                        <div class="card-body" bis_skin_checked="1">
                                            <div class="row d-block d-xl-flex align-items-center" bis_skin_checked="1">
                                                <div class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center" bis_skin_checked="1">
                                                    <div class="icon-shape icon-shape-secondary rounded me-4 me-sm-0" bis_skin_checked="1">
                                ...
                                <div class="col-12 col-sm-6 col-xl-4 mb-4" bis_skin_checked="1">
                                    <div class="card border-0 shadow" bis_skin_checked="1">
                                        <div class="card-body" bis_skin_checked="1">
                                            <div class="row d-block d-xl-flex align-items-center" bis_skin_checked="1">
                                                <div class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center" bis_skin_checked="1">
                                                    <div class="icon-shape icon-shape-tertiary rounded me-4 me-sm-0" bis_skin_checked="1">
